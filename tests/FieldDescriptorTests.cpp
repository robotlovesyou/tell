...
std::shared_ptr<FieldDescriptor> test_field(FieldDescriptor::Type t = FieldDescriptor::TYPE_STRING, bool optional = false, std::string name = "field_name", std::string doc = "field doc string", std::shared_ptr<MessageDescriptor> md = test_message()) {
